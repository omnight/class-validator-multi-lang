...
function ValidateNested(validationOptions) {
    ...
    const eachPrefix = opts.each ? (0, multi_lang_1.getText)('each value in ') : '';
    opts.message = opts.message || eachPrefix + (0, multi_lang_1.getText)('nested property $property must be either object or array');
