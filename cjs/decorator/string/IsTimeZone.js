...
function IsTimeZone(validationOptions) {
    return (0, ValidateBy_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)(eachPrefix => eachPrefix + (0, multi_lang_1.getText)('$property must be a valid IANA time-zone'), validationOptions),
        },
    }, validationOptions);
}
