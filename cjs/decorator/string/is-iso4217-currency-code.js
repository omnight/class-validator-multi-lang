...
exports.IS_ISO4217_CURRENCY_CODE = void 0;
...
function IsISO4217CurrencyCode(validationOptions) {
    return (0, ValidateBy_1.ValidateBy)({
        ...
        validator: {
            ...
            defaultMessage: (0, ValidateBy_1.buildMessage)(eachPrefix => eachPrefix + (0, multi_lang_1.getText)('$property must be a valid ISO4217 currency code'), validationOptions),
        },
    }, validationOptions);
}
